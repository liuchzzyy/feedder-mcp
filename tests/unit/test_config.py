...
def reset_dotenv_flag(monkeypatch):
    ...
    """
    import paper_feed.core.config as config_module
...
class TestEnsureDotenv:
    ...
    def test_ensure_dotenv_called_once(self):
        ...
        with mock.patch("paper_feed.core.config.load_dotenv") as mock_load:
    ...
    def test_ensure_dotenv_with_existing_file(self):
        ...
        with mock.patch("paper_feed.core.config.Path") as mock_Path:
            with mock.patch("paper_feed.core.config.load_dotenv") as mock_load:
...
class TestReloadConfig:
    ...
    def test_reload_config_resets_flag(self):
        ...
        with mock.patch("paper_feed.core.config.load_dotenv"):
...
class TestGetRssConfig:
    ...
    def test_get_rss_config_full_config(self):
        ...
        env_vars = {
            "PAPER_FEED_OPML": "/custom/path/feeds.opml",
            "PAPER_FEED_USER_AGENT": "custom-agent/2.0",
        }
        with mock.patch.dict(os.environ, env_vars):
            with mock.patch("paper_feed.core.config.load_dotenv"):
    ...
    def test_get_rss_config_with_defaults(self):
        ...
        with mock.patch.dict(os.environ, {}, clear=False):
            with mock.patch("paper_feed.core.config.load_dotenv"):
                ...
                assert config["user_agent"] == "paper-feed/1.0"
