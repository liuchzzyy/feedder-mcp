...
```
paper-feed/
├── AGENTS.md                  # AI Agent 开发指南（英文权威参考）
...
├── 测试.md                    # CLI 全流程测试报告
│
├── output/                    # Pipeline 运行输出（已 gitignore）
│
├── src/paper_feed/            # 主包
...
│
├── docs/
│   ├── ARCHITECTURE.md        # 详细架构文档（713 行）
│   ├── QUICKSTART.md          # 快速入门教程
│   ├── INSTALLATION.md        # 安装指南
│   ├── ADAPTERS.md            # 适配器文档
│   └── OPML_SUPPORT.md        # OPML 支持文档
│
├── examples/
│   ├── complete_workflow.py   # 端到端 获取 → 过滤 → 导出
│   ├── adapters_example.py    # 适配器使用示例
│   └── opml_example.py        # OPML 解析示例
│
└── feeds/
